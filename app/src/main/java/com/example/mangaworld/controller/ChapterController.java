...
public class ChapterController {
    ...
    public void getChapterById(int id, IVolleyCallback callback)
    {
        String urlPost = url + "/api/truyenchu/get_chapter_by_id.php";
        StringRequest request = new StringRequest(Request.Method.POST, urlPost, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                callback.onSuccess(response);
    ...
    public ChapterModel convertJSONChapter(String json)
    {
        try {
            JSONObject jsonObject = new JSONObject(json);
            ...
            chapter.setDatePost(jsonObject.getString("Date_Post"));
            chapter.setNovelID(jsonObject.getInt("ID_Novel"));
